		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creacion y Listado de Factura",
									"targetURL": "#nscosapicreacionlistadofactura-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapicreacionlistadofactura-display": {
								"semanticObject": "nscosapicreacionlistadofactura",
								"action": "display",
								"description": "Creacion y Listado de Factura",
								"title": "Creacion y Listado de Factura",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.creacionlistadofactura",
									"url": sap.ui.require.toUrl("ns/cosapi/creacionlistadofactura")
								}
							}
						}
					}
