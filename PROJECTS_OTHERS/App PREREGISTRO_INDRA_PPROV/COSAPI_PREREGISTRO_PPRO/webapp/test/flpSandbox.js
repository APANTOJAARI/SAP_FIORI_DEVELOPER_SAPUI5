		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pre Registro Proveedor",
									"targetURL": "#nscosapipreregistroproveedor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapipreregistroproveedor-display": {
								"semanticObject": "nscosapipreregistroproveedor",
								"action": "display",
								"description": "Pre Registro Proveedor",
								"title": "Pre Registro Proveedor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.preregistroproveedor",
									"url": sap.ui.require.toUrl("ns/cosapi/preregistroproveedor")
								}
							}
						}
					}
