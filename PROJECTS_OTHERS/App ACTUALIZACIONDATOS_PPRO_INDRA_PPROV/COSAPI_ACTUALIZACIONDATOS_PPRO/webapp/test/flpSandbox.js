		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nscosapiactualizacionproveedor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapiactualizacionproveedor-display": {
								"semanticObject": "nscosapiactualizacionproveedor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.actualizacionproveedor",
									"url": sap.ui.require.toUrl("ns/cosapi/actualizacionproveedor")
								}
							}
						}
					}
