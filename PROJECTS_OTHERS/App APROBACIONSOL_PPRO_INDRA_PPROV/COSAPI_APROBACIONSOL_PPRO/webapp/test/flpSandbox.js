		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprobación Solicitud Proveedores",
									"targetURL": "#nscosapiaprobacionsolppro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapiaprobacionsolppro-display": {
								"semanticObject": "nscosapiaprobacionsolppro",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.aprobacionsolppro",
									"url": sap.ui.require.toUrl("ns/cosapi/aprobacionsolppro")
								}
							}
						}
					}
