		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nscosapireportecontabilidad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapireportecontabilidad-display": {
								"semanticObject": "nscosapireportecontabilidad",
								"action": "display",
								"description": "Reporte Contabilidad",
								"title": "Reporte Contabilidad",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.reportecontabilidad",
									"url": sap.ui.require.toUrl("ns/cosapi/reportecontabilidad")
								}
							}
						}
					}
