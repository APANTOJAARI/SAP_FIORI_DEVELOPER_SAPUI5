sap.ui.define(
    [
        ...
        "ns/cosapi/reportecontabilidad/service/Exportation.service",
    ],
    function(Controller,
	UIComponent,
	History,Exportation) {
      ...
      return Controller.extend("ns.cosapi.reportecontabilidad.controller.Base", {
        onInit: function() {
          
        },
        onExportar: function () {
          Exportation.export(this.byId("idTableFacturas"), this.getView().getModel("i18n").getResourceBundle());
        },
        getRouter:function(){
