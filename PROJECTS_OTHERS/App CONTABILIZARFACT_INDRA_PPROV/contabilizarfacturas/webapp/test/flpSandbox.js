		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nscosapicontabilizarfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscosapicontabilizarfacturas-display": {
								"semanticObject": "nscosapicontabilizarfacturas",
								"action": "display",
								"description": "Contabilizar Facturas",
								"title": "Contabilizar Facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.cosapi.contabilizarfacturas",
									"url": sap.ui.require.toUrl("ns/cosapi/contabilizarfacturas")
								}
							}
						}
					}
