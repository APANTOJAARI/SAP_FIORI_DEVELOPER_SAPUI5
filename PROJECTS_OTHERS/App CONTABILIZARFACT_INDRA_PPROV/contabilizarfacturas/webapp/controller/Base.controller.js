sap.ui.define(
	...
	History) {
      ...
      return Controller.extend("ns.cosapi.contabilizarfacturas.controller.Base", {
        onInit: function() {
              ...
              if (this.readyState === 4) {
                  ...
                  if (oModel) {
                      ...
                      if (userData.Resources[0].groups) {
                        let oFindProv = userData.Resources[0].groups.find(oPos => oPos.display == "GRP_PROV_CONTABILIZAR_FACTURAS")
