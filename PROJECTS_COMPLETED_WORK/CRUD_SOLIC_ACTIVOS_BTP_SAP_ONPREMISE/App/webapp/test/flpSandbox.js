		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Solicitud de bajas de activos fijos",
									"targetURL": "#centrianetfisbactivos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"centrianetfisbactivos-display": {
								"semanticObject": "centrianetfisbactivos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=centria.net.fisbactivos",
									"url": sap.ui.require.toUrl("centria/net/fisbactivos")
								}
							}
						}
					}
